...
var number="89001234567 +79001234567 8 900 123 45 67 +7 900 123 45 67 8 (900) 123-45-67 +7 (900) 123-45-67 8(900)123-45-67 +7(900)123-45-67"
var reg=/((\b[8]|([+][7]))((\(?\d{3}\)?)|(\s\(?\d{3}\)?\s))\d{3}((\-)\d{2}(\-)|(\s?)\d{2}(\s?))\d{2}\b)/g
if(number.match(reg))
